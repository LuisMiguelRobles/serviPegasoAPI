        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelivererFullName = table.Column<string>(nullable: true),
                    DelivererEmail = table.Column<string>(nullable: true),
                    DelivererPhoneNumber = table.Column<string>(nullable: true),
                    DelivererBirthDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_Deliverers_DelivererId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDetailProductAmount = table.Column<int>(nullable: false),
                    OrderDetailSubTotal = table.Column<double>(nullable: false),
                    ProductId = table.Column<Guid>(nullable: false),
                    OrderId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
